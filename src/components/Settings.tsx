    ...
    <>
      <section className="p-5 ">
        ...
        <Select
          dir="rtl"
          onValueChange={(e) => {
            localStorage.setItem("font_type", e);
            location.reload();
          }}
          defaultValue={localStorage.getItem("font_type")! || "cairo"}
        >
          <SelectTrigger>
        ...
        <Select
          dir="rtl"
          onValueChange={(e) => {
            localStorage.setItem("font_size", e);
            location.reload();
          }}
          defaultValue={localStorage.getItem("font_size")! || "cairo"}
        >
          <SelectTrigger>
            <SelectValue placeholder="" />
          </SelectTrigger>
        ...
        <Label className="mb-3 mt-6">
          {" "}
          سرعة الانزلاق التلقائي <span> 1 الي 3.. 3 تعني نزول سريع </span>{" "}
        </Label>
        <section className="flex items-center gap-1 sm:gap-4 justify-between">
          <Select
            dir="rtl"
            onValueChange={(e) => {
              localStorage.setItem("scrolling_speed", e);
              location.reload();
            }}
            defaultValue={localStorage.getItem("scrolling_speed")! || "3"}
          >
            <SelectTrigger>
              <SelectValue placeholder="" />
            </SelectTrigger>
